...
county_list = [] 
county_votes_dict = dict.fromkeys(county_list,0) 
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict.keys():
        ...
        print(county_name + ": " + str(round(county_percentage,1)) + "% " + "(" + str("{:,}".format(county_votes)) + ")")
        
         # 6e: Save the county votes to a text file.
        county_votes_text = (county_name + ": " + str(round(county_percentage,1)) + "% " + "(" + str("{:,}".format(county_votes)) + ")\n")
        txt_file.write(county_votes_text)
